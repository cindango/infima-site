<script>
  import Terms from './../lib/legal/Terms.svelte'
</script>
...
<section id="content" class="container text">
	<Terms />
</section>
...
<style>
  ...
  :global(#content.text ol), :global(#content.text ul) {
    display: block;
  ...
  :global(#content.text ol), :global(#content.text ul), :global(#content.text li) {
